...
async function bootstrap() {
  ...
  fastify.register(async (instance) => {
    // Tolerate empty JSON bodies (e.g. POST /billing/portal sent with
    // Content-Type: application/json and no payload). Scoped to this plugin
    // so it does NOT collide with billing.webhook.ts's raw-buffer parser.
